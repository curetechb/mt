...
class ConversationController extends Controller
{
    ...
    public function index()
    {
        if (BusinessSetting::where('type', 'conversation_system')->first()->value == 1) {
            ...
            Session::flash("error",translate('Conversation is disabled at this moment'));
            return back();
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash("success",translate('Message has been sent to seller'));
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        if(Conversation::destroy(decrypt($id))){
            Session::flash("success",translate('Conversation has been deleted successfully'));
            return back();
        }
    }
}
