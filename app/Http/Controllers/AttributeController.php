...
class AttributeController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("success",translate('Attribute has been updated successfully'));
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash("success",translate('Attribute has been deleted successfully'));
        return redirect()->route('attributes.index');
    ...
    public function store_attribute_value(Request $request)
    {
        ...
        Session::flash("success",translate('Attribute value has been inserted successfully'));
    ...
    public function update_attribute_value(Request $request, $id)
    {
        ...
        Session::flash("success",translate('Attribute value has been updated successfully'));
        return back();
    }
    ...
    public function destroy_attribute_value($id)
    {
        ...
        Session::flash("success",translate('Attribute value has been deleted successfully'));
    ...
    public function store_color(Request $request) {
        ...
        Session::flash("success",translate('Color has been inserted successfully'));
    ...
    public function update_color(Request $request, $id)
    {
        ...
        Session::flash("success",translate('Color has been updated successfully'));
        return back();
    }
    ...
    public function destroy_color($id)
    {
        ...
        Session::flash("success",translate('Color has been deleted successfully'));
        return redirect()->route('colors');
