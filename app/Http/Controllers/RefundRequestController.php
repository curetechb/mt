...
class RefundRequestController extends Controller
{
    ...
    public function request_store(Request $request, $id)
    {
        ...
        if ($refund->save()) {
            Session::flash("success", translate("Refund Request has been sent successfully"));
    ...
    public function refund_time_update(Request $request)
    {
        ...
        Session::flash("success", translate("Refund Request sending time has been updated successfully"));
        return back();
    }
    ...
    public function refund_sticker_update(Request $request)
    {
        ...
        Artisan::call('cache:clear');
        Session::flash("success", translate("Refund Sticker has been updated successfully"));
        return back();
    }
    ...
    public function reject_refund_request(Request $request){
      ...
      if ($refund->save()) {
          Session::flash("success",translate('Refund request rejected successfully.'));
          return back();
      }
      else {
          return back();
