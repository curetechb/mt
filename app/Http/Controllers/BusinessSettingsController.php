...
class BusinessSettingsController extends Controller
{
    ...
    public function payment_method_update(Request $request)
    {
        ...
        Session::flash("success",translate("Settings updated successfully"));
        return back();
    }
    ...
    public function google_map_update(Request $request)
    {
        ...
        Session::flash("success",translate("Settings updated successfully"))->success();
        return back();
    }
    ...
    public function seller_verification_form_update(Request $request)
    {
        ...
        if($business_settings->save()){
            ...
            Session::flash("success",translate("Verification form updated successfully"));
            return back();
        }
    }
    ...
    public function vendor_commission_update(Request $request){
        ...
        Session::flash("success",translate('Seller Commission updated successfully'));
        return back();
    }
