...
class CustomerPackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash("success",translate('Package has been inserted successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("success",translate('Package has been updated successfully'));
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash("success",translate('Package has been deleted successfully'));
        return redirect()->route('customer_packages.index');
    }
    ...
    public function purchase_package(Request $request)
    {
        ...
        if ($customer_package->amount == 0) {
            ...
            if ($user->customer_package_id != $customer_package->id) {
                ...
                Session::flash("error",translate('You can not purchase this package anymore.'));
                return back();
            }
        }
    ...
    public function purchase_payment_done($payment_data, $payment)
    {
        ...
        Session::flash("success",translate('Package purchasing successful'));
    ...
    public function purchase_package_offline(Request $request)
    {
        ...
        $customer_package->save();
        Session::flash("success",translate('Offline payment has been done. Please wait for response.'));
