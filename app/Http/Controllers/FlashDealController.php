...
class FlashDealController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($flash_deal->save()){
            ...
            Session::flash("success",translate('Flash Deal has been inserted successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if($flash_deal->save()){
            ...
            Session::flash("success",translate('Flash Deal has been updated successfully'));
            return back();
        }
        else{
            Session::flash("error",translate('Something went wrong'));
    ...
    public function destroy($id)
    {
        ...
        Session::flash("success",translate('FlashDeal has been deleted successfully'));
        return redirect()->route('flash_deals.index');
    }
    ...
    public function update_status(Request $request)
    {
        ...
        if($flash_deal->save()){
            Session::flash("success",translate('Flash deal status updated successfully'));
            return 1;
        }
        return 0;
    }
