...
//        $pickup_point->address = $request->address;
        ...
        if ($tax->save()) {
            ...
            Session::flash("success",translate('Tax has been inserted successfully'));
...
//        $language->code = $request->code;
        if($tax->save()){
            Session::flash("success",translate('Tax has been updated successfully'));
            return redirect()->route('tax.index');
        }
        else{
            Session::flash("error",translate('Something went wrong'));
...
//        $tax = Tax::findOrFail($id);
        ...
        if(Tax::destroy($id)){
            Session::flash("success",translate('Tax has been deleted successfully'));
            return redirect()->route('tax.index');
        }
        else{
            Session::flash("error",translate('Something went wrong'));
