...
class AddressController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach (Auth::user()->addresses as $key => $add) {
            $add->set_default = 0;
            $add->save();
        }
    ...
    public function show($id)
    {
        ...
        Session::flash("error",translate('Default address can not be deleted'));
        return back();
    }
...
//        return ;
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("success",translate('Address info updated successfully'));
        return back();
    }
