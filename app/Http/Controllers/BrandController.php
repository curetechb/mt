...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash("success",translate('Brand has been inserted successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("success",translate('Brand has been updated successfully'));
        return back();
    ...
    public function destroy($id)
    {
        ...
        Session::flash("success",translate('Brand has been deleted successfully'));
        return redirect()->route('brands.index');
