...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(count(Coupon::where('code', $request->coupon_code)->get()) > 0){
            Session::flash("error",translate('Coupon already exist for this coupon code'));
            return back();
        }
        ...
        Session::flash("success",translate('Coupon has been saved successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("success",translate('Coupon has been updated successfully'));
        return redirect()->route('coupon.index');
    }
    ...
    {
        Coupon::destroy($id);
        Session::flash("success",translate('Coupon has been deleted successfully'));
        return redirect()->route('coupon.index');
    }
