...
class StateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash("success",translate('State has been inserted successfully'));
        return back();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("success",translate('State has been updated successfully'));
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash("success",translate('State has been deleted successfully'));
