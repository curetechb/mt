...
class PageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Page::where('slug', preg_replace('/[^A-Za-z0-9\-]/', '', str_replace(' ', '-', $request->slug)))->first() == null) {
            ...
            Session::flash("success",translate('New page has been created successfully'));
            return redirect()->route('website.pages');
        }

        Session::flash("error",translate('Slug has been used already'));
        return back();
    }
   ...
   public function edit(Request $request, $id)
   {
    ...
    public function update(Request $request, $id)
    {
        ...
        if (Page::where('id','!=', $id)->where('slug', preg_replace('/[^A-Za-z0-9\-]/', '', str_replace(' ', '-', $request->slug)))->first() == null) {
            ...
            Session::flash("success",translate('Page has been updated successfully'));
            return redirect()->route('website.pages');
        }
    ...
    public function destroy($id)
    {
        ...
        if(Page::destroy($id)){
            Session::flash("success",translate('Page has been deleted successfully'));
