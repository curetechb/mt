...
class PickupPointController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($pickup_point->save()) {
            ...
            Session::flash("success",translate('PicupPoint has been inserted successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($pickup_point->save()) {
            ...
            Session::flash("success",translate('PicupPoint has been updated successfully'))->success();
            return redirect()->route('pick_up_points.index');
        }
        else{
            Session::flash("error",translate('Something went wrong'));
    ...
    public function destroy($id)
    {
        ...
        if(PickupPoint::destroy($id)){
            Session::flash("success",translate('PicupPoint has been deleted successfully'));
            return redirect()->route('pick_up_points.index');
        }
        else{
            Session::flash("error",translate('Something went wrong'));
