...
class SupportTicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($ticket->save()){
            ...
            Session::flash("success",translate('Ticket has been sent successfully'));
    ...
    public function admin_store(Request $request)
    {
        ...
        if($ticket_reply->save()){
            Session::flash("success",translate('Reply has been sent successfully'))->success();
    ...
    public function seller_store(Request $request)
    {
        ...
        if($ticket_reply->save()){
            ...
            Session::flash("success",translate('Reply has been sent successfully'));
            return back();
        }
        else{
            Session::flash("error",translate('Something went wrong'));
