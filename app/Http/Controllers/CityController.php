...
class CityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash("success",translate('City has been inserted successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("success",translate('City has been updated successfully'));
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash("success",translate('City has been deleted successfully'));
