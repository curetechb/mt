	...
	<div>
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
            <table>
				...
				<tr>
				    <td class="gry-color small">{{ $shipping_address->address }}, {{ $shipping_address->state }}, Floor No - {{ $shipping_address->floor_no }}, Apartment - {{ $shipping_address->apartment }}</td>
				</tr>
	        ...
	        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
		        <tbody>
			        ...
			        <tr>
			            ...
			            <td class="currency">{{ single_price(get_setting("flat_rate_shipping_cost")) }}</td>
			        </tr>
