            ...
            <div class="text-left">
                ...
                @else
                    <div class="row no-gutters mt-3">
                        ...
                        <div class="col-10">
                            <div class="">
                                <strong class="h2 fw-600 card-price">
                                    {{ home_discounted_price($product) }}
                                </strong>
                                {{-- <span class="opacity-70">/{{ $product->unit }}</span> --}}
                                <span class="opacity-70">/{{$product->unit_value > 0 ? $product->unit_value : ""}} {{ $product->unit }}</span>
                            </div>
                        </div>
                    </div>
                @endif
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center mx-3">
                                        ...
                                        <div class="@if($incart) pbtn @endif d-flex align-items-center justify-content-between addtocartplusminus product_{{ $product->id }}" data-id="{{ $product->id }}">
                                            <button class="cartbtn" data-id="minus" type="button">-</button>
                                            <button type="button" data-id="plus" class="cartbtn modalcarttext w-100" style="background: #fff;border-left: 1px solid #eee; border-right: 1px solid #eee; color: #333;">{{ $incart ? $incart->quantity." in Bag" : "0 in Bag" }}</button>
                                            <button class="cartbtn" data-id="plus" type="button">+</button>
                                        </div>
                ...
                <div class="mt-3">
                    ...
                    @if ($stock->qty > $product->low_stock_quantity)
                        <div data-id="{{ $product->id }}">
                            <a href="javascript::void()" class="btn btn-primary fw-600 cartbtn buy-now-btn">
                                <i class="la la-shopping-cart"></i>
