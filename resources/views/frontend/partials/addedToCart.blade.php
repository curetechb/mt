            ...
            <div class="text-left">
                ...
                <form id="option-choice-form">
                    ...
                    @if($product->digital !=1)
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center mx-3">
                                        @php
                                            $mqty = $product->min_qty;
                                            $temp_user = session("temp_user_id");
                                            $incart = \App\Models\Cart::where('temp_user_id', $temp_user)->where("product_id", $product->id)->first();
                                            $mqty = $incart ? $incart->quantity : $mqty;
                                        @endphp
                                        <div class="d-flex align-items-center justify-content-between addtocartplusminus product_{{ $product->id }}" data-id="{{ $product->id }}">
                                            <button class="addtocartbtnfirst" type="button">-</button>
                                            <input type="hidden" name="qty" class="qty" data-id="{{ $incart->id ?? '' }}" value="{{ $incart ? $incart->quantity : 0 }}">
                                            <button type="button" class="addtobag w-100" style="background: #fff;border: 1px solid #eee; color: #333;">{{ $incart ? $incart->quantity." in Bag" : "Add to Bag" }}</button>
                                            <button class="addtocartbtnlast" type="button">+</button>
                                        </div>
                                    <div class="avialable-amount opacity-60 ml-2">
                ...
                <div class="mt-3">
                    ...
                    @elseif($qty > 0)
                        ...
                        @endif
                    @endif --}}
                    <a href="javascript::void()" class="btn btn-primary buy-now fw-600 add-to-cart" onclick="buyNow()">
                        <i class="la la-shopping-cart"></i>
