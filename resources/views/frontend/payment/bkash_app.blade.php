...
<body>
    ...
    <script type="text/javascript">
        ...
        paymentRequest: {
            amount: '{{ $order->grand_total - $order->coupon_discount - $order->reward_discount }}', //max two decimal points allowed
            intent: 'sale'
        },
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (result && result.paymentID != null) {
                ...
                window.location.href = "{{ route('api.bkash.fail') }}?payment_details="+data; //Merchant’s success page
