                ...
                @if(Auth::user()->addresses != null)
                    ...
                    @if($address != null)
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class=" py-2"><span>{{ translate('Area') }} : {{ $address->state->name ?? "" }}</span></li>
                            <li class=" py-2"><span>{{ translate('Floor Number') }} : {{ $address->floor_no }}</span></li>
                            <li class=" py-2"><span>{{ translate('Apartment') }} : {{ $address->apartment }}</span></li>
                            <li class=" py-2"><span>{{ translate('Name') }} : {{ $address->name }}</span></li>
