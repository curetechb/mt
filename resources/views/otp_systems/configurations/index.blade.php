            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="BULK_SMS_BD_USERNAME">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('BULK_SMS_BD_USERNAME')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="BULK_SMS_BD_USERNAME" value="{{  env('BULK_SMS_BD_USERNAME') }}" placeholder="BULK_SMS_BD_USERNAME" required>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="BULK_SMS_BD_PASSWORD" value="{{  env('BULK_SMS_BD_PASSWORD') }}" placeholder="BULK_SMS_BD_PASSWORD" required>
                            </div>
                        </div>
