    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'bulksmsbd')" @if(\App\Models\OtpConfiguration::where('type', 'mimsms')->first() != null && \App\Models\OtpConfiguration::where('type', 'bulksmsbd')->first()->value == 1) checked @endif>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
