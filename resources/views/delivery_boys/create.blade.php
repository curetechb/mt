            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="phone" value="{{ old('phone') }}" placeholder="Phone" required autocomplete="new-password">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="password" value="{{ old('password') }}" placeholder="Password" required autocomplete="new-password">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="emergency_contact_number" value="{{ old('emergency_contact_number') }}" placeholder="Emergency Contact Number" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nid" value="{{ old('nid') }}" placeholder="NID" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="nid_image" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="nid_image_backpart" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="area" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check-inline">
                                ...
                                <input type="checkbox" name="cycle" class="form-check-input" value="cycle">Cycle
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                <input type="checkbox" name="motor_bike" class="form-check-input" value="motor_bike">Motor Bike
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                <input type="checkbox" name="by_walk" class="form-check-input" value="by_walk">By Walk
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="registration_number" value="{{ old('registration_number') }}" placeholder="Registrtion Number" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="license" value="{{ old('license') }}" placeholder="License" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="license_image" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="license_image_backpart" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
