        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-from-label">{{translate('Rider Base Commision')}}</label>
                        <div class="col-sm-8">
                            <input type="hidden" name="types[]" value="rider_base_commission">
                            <div class="input-group">
                                <input type="number" name="rider_base_commission" class="form-control" value="{{ get_setting('rider_base_commission') ? get_setting('rider_base_commission') : "0" }}">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend">
                                        for 1KM
                                    </span>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-from-label">{{translate('Commission for Next KM')}}</label>
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend">
                                        {{ \App\Models\Currency::find(get_setting('system_default_currency'))->code }} /KM
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-from-label">{{translate('Maximum Delivery Limit')}}</label>
                        <div class="col-sm-8">
                            <input type="hidden" name="types[]" value="maximum_delivery_limit">
                            <div class="input-group">
                                <input type="number" name="maximum_delivery_limit" class="form-control" value="{{ get_setting('maximum_delivery_limit') ? get_setting('maximum_delivery_limit') : "0" }}">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend">
                                        {{ \App\Models\Currency::find(get_setting('system_default_currency'))->code }}
                                    </span>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-from-label">{{translate('Minimum Payment Request Amount')}}</label>
                        <div class="col-sm-8">
                            <input type="hidden" name="types[]" value="minimum_payment_request_amount">
                            <div class="input-group">
                                <input type="number" name="minimum_payment_request_amount" class="form-control" value="{{ get_setting('minimum_payment_request_amount') ? get_setting('minimum_payment_request_amount') : "0" }}">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend">
                                        {{ \App\Models\Currency::find(get_setting('system_default_currency'))->code }}
                                    </span>
