            ...
            <div class="card-body">
                <form action="{{ route('stories.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Duration') }}" id="duration" name="duration"
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="show_on_front">{{ translate('Show on Front') }}</label>
                        <div class="col-sm-9">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input value="1" name="show_on_front" type="checkbox">
