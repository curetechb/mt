    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if (Auth::user()->user_type == 'admin' || Auth::user()->staff->role->id == 5)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('b2b_orders.index') }}" class="aiz-side-nav-link">
                            <i class="las la-home aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('B2B Orders') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('25', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('stockout.history') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('StockOut History') }}</span>
                                </a>
                            </li>
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('products.all', ['mt' => 'ok']) }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('MT Products') }}</span>
                                </a>
                            </li>
                        ...
                        @if (Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.index') }}"
                                    ...
                                    <span class="aiz-side-nav-text">{{ translate('Online Orders') }}</span>
                                </a>
                            </li>
                        @endif
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('26', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('rider.payment.history') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Payment Histories') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('rider.order.collections') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Collection Histories') }}</span>
                                </a>
                            </li>
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('subscription.configuration') }}" class="aiz-side-nav-link">
                                    <span
                                        class="aiz-side-nav-text">{{ translate('Subscription Configuration') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if (Auth::user()->user_type == 'admin')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('story-group.index') }}" class="aiz-side-nav-link">
                            <i class="las la-shopping-cart aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Stories') }}</span>
                            <!-- <span class="aiz-side-nav-arrow"></span> -->
                        </a>
                    </li>
                @endif
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.b2b.request') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('B2B Requests') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.b2b') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('B2B Customer list') }}</span>
                                </a>
                            </li>
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('cancel_list.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['customer_packages.index', 'customer_packages.create', 'customer_packages.edit']) }}">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('emergency.balance') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Emergency Balance') }}</span>
                                </a>
                            </li>
                ...
                @if (Auth::user()->user_type == 'admin')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('price-histories.index') }}" class="aiz-side-nav-link">
                            <i class="las la-shopping-cart aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Price History') }}</span>
                            <!-- <span class="aiz-side-nav-arrow"></span> -->
                        </a>
                    </li>
                @endif
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('push-notification.index') }}" class="aiz-side-nav-link">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('referral') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['referral']) }}">
