...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        ...
        {{-- <div class="col">
            <div class="dropdown">
                <button class="btn btn-danger dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                    {{translate('Price Scrapper')}}
                </button>
                <div class="dropdown-menu">
                    <form action="{{ route('price.scrapper') }}" method="GET" class="p-3">
                        <div class="mb-3">
                            <label for="page">Page No.</label>
                            <input type="text" id="page" class="form-control" name="page" value="1">
                        </div>
                        <div class="mb-3">
                            <label for="per_page">Per Page</label>
                            <input type="text" class="form-control" id="per_page" name="per_page" value="100">
                        </div>
                        <div class="mb-3">
        ...
        <div class="col">
            <a href="{{ route("price.scrapper2") }}" class="btn btn-danger">Price Scrapper</a>
        </div>
        <div class="col text-right">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="{{route('product_bulk_import.index')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Upload Product File</h5>
                ...
                {{-- <a href="{{ route('price.scrapper') }}" class="btn btn-circle btn-info">
                    <span>{{translate('Price Scrapper')}}</span>
                </a> --}}
            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($product->current_stock <= $product->low_stock_quantity)
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-success btn-icon btn-circle btn-sm"  href="https://muslim.town/product/{{ $product->slug }}" target="_blank" title="{{ translate('View') }}">
                                <i class="las la-eye"></i>
                            </a>
