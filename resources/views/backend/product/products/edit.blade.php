            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="unit_value" placeholder="" value="{{ $product->unit_value }}" required>
                                        <div class="input-group-prepend">
                                            ...
                                            <select name="unit" id="unit" class="form-control">
                                                ...
                                                <option @if($product->unit == "ltr") selected @endif value="ltr">Ltr</option>
                                                <option @if($product->unit == "bundle") selected @endif value="bundle">Bundle</option>
                                                <option @if($product->unit == "set") selected @endif value="set">Set</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {{-- <input type="hidden" lang="en" class="form-control" name="min_qty" value="1" min="1" value="1"> --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="attribute_name" placeholder="{{translate('Attribute Name')}}" value="{{ $product->attribute_name }}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control aiz-tag-input" name="attribute_values[]" value="{{ $product->attribute_values }}" placeholder="{{ translate('Type and hit enter to add') }}" data-role="attributesinput">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" placeholder="{{translate('Selling price')}}" name="unit_price" id="unit_price" class="form-control" value="{{$product->unit_price}}" required>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" placeholder="{{translate('Regular price')}}" name="regular_price" id="regular_price" class="form-control" value="{{$product->regular_price}}" >
                            </div>
                            <div class="col-lg-3">
                                {{-- <button type="button" class="btn btn-primary" id="getCDprice">Get CD Price</button> --}}
                            </div>
...
<!--                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('CD URL')}}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="clink" id="clink" value="{{ $product->clink }}">
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="form-group row w-100">
                            <label class="col-lg-3 col-from-label">{{translate('Is B2B Product')}}</label>
                            <div class="col-lg-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="is_b2b_product" @if($product->is_b2b_product) checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                {{-- <div class="card">
                    ...
                    <div class="card-body collapse show" id="collapse_2">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label d-flex">{{translate('Weight')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="weight" placeholder="{{ translate('Weight') }}" value="{{ $product->weight }}" required>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="form-group row m-3">
                        <label class="col-md-4 col-from-label">{{translate('Free Shipping')}}</label>
                        <div class="col-md-8">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" name="free_shipping" @if($product->free_shipping) checked @endif>
                                <span></span>
                            </label>
                        </div>
                    </div>
