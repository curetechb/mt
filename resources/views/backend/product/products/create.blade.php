                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="unit_value" placeholder="{{ translate('1') }}" required>
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-group row w-100">
                            ...
                            <div class="col-lg-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="is_b2b_product">
                                    <span></span>
                                </label>
                            </div>
                        </div>
                ...
                {{-- <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="weight" placeholder="{{ translate('Weight') }}" required>
                            </div>
                        </div>
                ...
                {{-- <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="stock_visibility_state" value="text" checked>
                                    <span></span>
                                </label>
                            </div>
                        </div>
