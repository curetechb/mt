        ...
        <form action="{{ route('delivery-boys.update', $delivery_boy->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nid" value="{{ $delivery_boy->delivery_boy->nid ?? "" }}" placeholder="NID" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                            ...
                            <input type="hidden" name="nid_image" value="{{ $delivery_boy->delivery_boy->nid_image }}" class="selected-files">
                        </div>
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label">{{translate('Ride Type')}}</label>
                    <div class="col-sm-10">
                        <div class="form-check-inline">
                            <label class="form-check-label">
                              <input type="checkbox" name="bike" class="form-check-input" value="bike" @if($delivery_boy->delivery_boy->has_bike) checked @endif>Bike
                            </label>
                          </div>
                          <div class="form-check-inline">
                            <label class="form-check-label">
                              <input type="checkbox" name="motor_bike" class="form-check-input" value="motor_bike" @if($delivery_boy->delivery_boy->has_motorbike) checked @endif>Motor Bike
                            </label>
                          </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="license" value="{{ old('license', $delivery_boy->delivery_boy->license) }}" placeholder="License" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="license_image" value="{{ $delivery_boy->delivery_boy->license_image }}" class="selected-files">
                        </div>
                        <div class="file-preview box sm">
                        </div>
                    </div>
